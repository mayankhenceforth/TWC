...
import { Payout, PayoutDocument, PendingUser, PendingUserDocument, User, UserDocument } from 'src/comman/Schema/user.schema';
...
export class AuthService {
    ...
    private async getPendingUser(email: string): Promise<PendingUserDocument | null> {
    ...
    async signUp(signUpDto: SignUpDto) {
        const existingUser = await this.pendingUserModel.findOne({
